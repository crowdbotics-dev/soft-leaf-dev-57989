"""
Django settings for soft_leaf_dev_57989 project.
...
ROOT_URLCONF = 'soft_leaf_dev_57989.urls'
...
WSGI_APPLICATION = 'soft_leaf_dev_57989.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "soft_leaf_dev_57989 API",
    "DESCRIPTION": "API documentation for soft_leaf_dev_57989 App",
    "VERSION": "v1",
}
